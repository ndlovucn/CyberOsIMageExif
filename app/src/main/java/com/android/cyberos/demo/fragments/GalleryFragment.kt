...
import com.android.cyberos.demo.BuildConfig
import com.android.cyberos.demo.utils.padWithDisplayCutout
import androidx.appcompat.app.AlertDialog
import androidx.fragment.app.FragmentStatePagerAdapter
import androidx.navigation.Navigation
import androidx.navigation.fragment.navArgs
import com.android.cyberos.demo.utils.showImmersive
import com.android.cyberos.demo.R
import com.android.cyberos.demo.databinding.FragmentGalleryBinding
import com.android.cyberos.demo.getLocationInfo
...
//
//                    val latlon = activity?.applicationContext?.let { it1 -> getLocationInfo(it1, uri) }
//                    val latString = latlon?.get(0).toString()
//                    val lonString = latlon?.get(1).toString()
//
//                    Navigation.findNavController(
//                            requireActivity(), R.id.fragment_container
//                    ).navigate(GalleryFragmentDirections
//                            .actionGalleryToMap(arrayOf(latString, lonString)))
//                }
